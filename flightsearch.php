...
inner join flight_details as f
on f.fare_id=a.fare_id
where r.source='$to'and r.destination='$from' and f.flight_date='$return' and f.eco_seatcount>='$count';";
...
$flight1[$k]=$k+1 ." --> ".$row['fid1']."   <br>   ARRIVAL:        " .$row['fdt1']."   <br>    DEPARTURE:  ".$row['fat1']." <br>ADULTFARE:".$row['aef1']."<br>CHILDFARE:" .$row['aecf1'];

?>

<input type="radio" name="fradio1" value="<?php echo $flightselect1[$k];?>" required><?php echo $flight1[$k];?><br>
<br><br><br>
